    ...
    return (
        <React.Fragment>
            ...
            <Breadcrumb 
                ...
                title="Education Guidence"
                content="Home"
                contentTwo="Education Guidence"
            />
        <div className="blog-3 col">
            <div className="row">
                <div className="col-md-6">
                <div className="image-container" style={{padding:"20px"}}>
                    <img src="images/Services/library-488690_1280.jpg" alt="Blog Image" className="img-fluid" />
                    
                </div>
                </div>
                <div className="col-md-6">
                <div className="info">
                    <h3 className="title">Education Guidence</h3>
