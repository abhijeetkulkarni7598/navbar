    ...
    return (
        <React.Fragment>
            ...
            <Breadcrumb 
                ...
                title="Micro Guidence"
                content="Home"
                contentTwo="Micro Guidence"
            /><br/>
        <div className="blog-3 col">
            <div className="row">
                <div className="col-md-6">
                <div className="image-container" style={{padding:"20px"}}>
                    <img src="images/Services/financial-3207895_1280.jpg" alt="Blog Image" className="img-fluid" />
                    
                </div>
                </div>
                <div className="col-md-6">
                <div className="info">
                    <h3 className="title">Micro Guidence</h3>
